...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        //Cuando tiene _ Es un atributo Privado
        ...
        //Metodo Asincrono
        //Los Metodos Asincronos Se Supone que todos tienen un apellido que es Async() En este Caso SeedAsync()
        public async Task SeedAsync()
        {
            //Cuando Pase por este punto la base de datos sera creada y el await es para que espere que cree la base de datos
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "nascetur ridiculus mus. Nullam volutpat ultrices ex, sed cursus sem tincidunt ut. Nullam metus" + 
                    "lorem, convallis quis dignissim quis, porttitor quis leo. In hac habitasse platea dictumst." + 
